...
public enum RakNetAddressIP: Hashable, Sendable {
...
public struct RakNetAddress: Hashable, Sendable {
    let ip: RakNetAddressIP
    let port: UInt16

    public init(ip: RakNetAddressIP, port: UInt16) {
        self.ip = ip
        self.port = port
    }
